...
* Fill out the config.json file (instructions [here](Sparkle-Turntable-Bot/master/CONFIG.md)) with your bot account's user ID, auth code, target room ID, admin ID info, and other options
